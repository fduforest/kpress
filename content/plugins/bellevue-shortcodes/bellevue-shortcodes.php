<?php
/*
Plugin Name: Bellevue Shortcodes
...
function bellevue_shortcodes_load_textdomain() {
    load_plugin_textdomain( THEMO_TEXT_DOMAIN, FALSE, basename( dirname( __FILE__ ) ) . '/lang' );
}

add_action( 'plugins_loaded', 'bellevue_shortcodes_load_textdomain' );
				...
				<div id="su-generator-shell">
					<div id="su-generator-header">
						...
						<div id="su-generator-tools">
							<a href="<?php _e( 'http://docs.themovation.com/bellevue/#shortcodes', 'themo' ); ?>" target="_blank" title="<?php _e( 'Help', THEMO_TEXT_DOMAIN ); ?>"><?php _e( 'Help', THEMO_TEXT_DOMAIN ); ?></a>
						</div>
					</div>
