...
{   
    ...
    if($currentCalendar == 1){
        $output .= '<a href="#" class="wpbs-prev" title="Previous"><img src="'.WPBS_PATH.'/images/arrow-left.png" alt="Previous" /></a>';
    ...
    if($currentCalendar == $totalCalendars)
        $output .= '<a href="#" class="wpbs-next" title="Next"><img src="'.WPBS_PATH.'/images/arrow-right.png" alt="Next" /></a>';
    $output .= "</div>";
