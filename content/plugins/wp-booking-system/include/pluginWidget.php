...
class wpbs_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        echo do_shortcode('[wpbs id="'.$instance['wpbs_select_calendar'].'" form="'.$instance['wpbs_select_form'].'" title="'.$instance['wpbs_show_title'].'" legend="'.$instance['wpbs_show_legend'].'" start="'.$instance['wpbs_calendar_start'].'" display="'.$instance['wpbs_calendar_view'].'" language="'.$instance['wpbs_calendar_language'].'" tooltip="'.$instance['wpbs_calendar_tooltip'].'" history="'.$instance['wpbs_calendar_history'].'" selection="'.$instance['wpbs_calendar_selection_type'].'" autopending="'.$instance['wpbs_calendar_auto_pending'].'" weeknumbers="'.$instance['wpbs_calendar_weeknumbers'].'" minimumdays="'.$instance['wpbs_calendar_minimumdays'].'" formposition="'.$instance['wpbs_form_position'].'"]');
        echo '</div>';
