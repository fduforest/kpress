...
function wpbs_menu(){
    ...
    add_submenu_page( 'wp-booking-system', __('Default Legend','wpbs'), __('Default Legend','wpbs'), 'read_private_pages', 'wp-booking-system-default-legend', 'wpbs_default_legend' );
    add_submenu_page( 'wp-booking-system', __('Forms','wpbs'), __('Forms','wpbs'), 'read_private_pages', 'wp-booking-system-forms', 'wpbs_forms' );
    add_submenu_page( 'wp-booking-system', __('Sync'), __('Sync'), 'read_private_pages', 'wp-booking-system-ical', 'wpbs_ical' );
...
if(isset($_GET['wp-booking-system-ical']) && !empty($_GET['wp-booking-system-ical'])){
