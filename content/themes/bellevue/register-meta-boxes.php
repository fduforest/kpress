...
function _themo_general_meta_boxes($meta_boxes) {
    ...
    /* Icons */
    list($glyphicons_icon_set,$glyphicons_icon) = themo_return_icons($key,$i,'checkbox-condition themo_room_show_icon');
    ...
    $themo_room_options_meta_box = array(
        'id'          => $key."_meta_box",
        //'autosave'   => true,
        'title'       =>  'Room Options',
        'post_types' => $post_types,
        ...
        'fields'      => array(
            ...
            array(
                'id'          => 'themo_room_show_icon',
                'name'       => 'Show Room Type Icon',
                'desc'       => '',
                'std'         => 0,
                'type'        => 'checkbox',
                'class' => 'checkbox-switch'
            ...
            array(
                'id'          => 'themo_room_lightbox',
                'name'       =>  'Enable Lightbox on Rooms Home',
    ...
    $meta_boxes[] = $themo_room_options_meta_box;


    //-----------------------------------------------------
    // Rooms Options
    //-----------------------------------------------------
    $key = 'themo_rooms_options';
    $name = 'Rooms';
    //$i = '1';



    $themo_rooms_options_meta_box = array(
        'id'          => $key."_meta_box",
        //'autosave'   => true,
        'title'       =>  'Rooms Options',
        'pages'       => array( 'page' ),
        ...
        'priority'    => 'high',
        'fields'      => array(
            // START ROOMS OPTIONS META BOX

            array(
                'id'          => 'themo_rooms_filter_bar',
                'name'       =>  'Show Room Filter Bar',
                'desc'       => '',
                'std'         => 0,
                'type'        => 'checkbox',
                'class' => 'checkbox-switch'
            ...
            array(
                ...
                'desc'        =>  'Select the Room Types you wish to include',
            ),
            array(
                'id'          => 'themo_rooms_per_page',
                'name'       =>  'Room per page.',
    ...
    $meta_boxes[] = $themo_rooms_options_meta_box;
    ...
    $themo_page_layout_meta_box = array(
        ...
        //'autosave'   => true,
        'title'       =>  'Page Layout',
        'pages'       => array( 'page' , 'themo_rooms', 'product'),
        'context'     => 'side',
        'priority'    => 'default',
        'fields'      => array(
    ...
    $themo_meta_box_builder_meta = array(
        ...
        'fields'      => array(
            array(
                ...
                'name'       =>  'Meta Boxes',
                'type'        => 'checkbox_list',
                'desc' => "<p>Need help? <a href='http://docs.themovation.com/bellevue/#metaboxbuilder' target='_blank'>Meta Box Documentation</a></p>",
                'options' => array(
                    'accordion' =>  'Accordion',
                    ...
                    'wp_booking_calendar' =>  'WP Booking System',
                ),
...
//-----------------------------------------------------
            ...
            for ($i = 1;$i <= $meta_box_multiply;$i++) { // LOOP
                ...
                $locked_options = array(
                    ...
                    $show_background,$background_color,$background_image,$parallax,$background_repeat,$background_attachment,$background_position,$background_size,$text_contrast,
                    array(
                        'id'          => $key."_".$i.'_frost_contrast',
                        'name'       =>  'Speech bubble contrast',
                        'std'         => 'default',
                        'type'        => 'radio',
                        'options'  => array(
                            'default'  => 'Default',
...
//-----------------------------------------------------
            ...
            for ($i = 1;$i <= $meta_box_multiply;$i++) { // LOOP
                ...
                /* Get Term Options */
                list($terms_options) = themo_return_term_options($key,$i,'themo_room_type','Room Type');

                /* Order By Options */
                list($order_by_options) = themo_return_order_by_options($key,$i,$name);


                $themo_rooms_meta = array(
                    'id'          => $key."_".$i."_meta_box",
                    //'autosave'   => true,
                    'title'       => $name.themo_return_meta_box_number($i),
                    'pages'       => array( 'page', 'themo_rooms' ),
                ...
                // Check for Edit Lock / hide locked meta box options of ON
                $themo_rooms_meta = themo_edit_lock_check($key,$i,$locked_options,$themo_rooms_meta);

                //ot_register_meta_box( $themo_rooms_meta );
                $meta_boxes[] = $themo_rooms_meta;
            }

            break;

        case "wp_booking_calendar":
//-----------------------------------------------------
// WP BOOKING CALENDAR
//-----------------------------------------------------
            $key = 'themo_wp_booking_calendar';
            ...
            for ($i = 1;$i <= $meta_box_multiply;$i++) { // LOOP
                ...
                $locked_options = array(
                    ...
                    array(
                        'id'          => $key."_".$i.'_shortcode',
                        'name'       =>  'WP Booking Calendar Shortcode',
                        'placeholder' =>  '[wpbs id=1 display=1]',
                        'type'        => 'text',
                        'class' => 'checkbox-condition '.$key."_".$i.'_show',
                        'tab'  =>  $key,
                    ),
