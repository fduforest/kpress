...
$floating_block_show = get_post_meta($post->ID, $key.'_show_floating_block', true );
 ...
 if($floating_block_show == 1){
	...
	$tour_content = get_post_meta($post->ID, $key.'_content', true );
	 $tour_content_bottom = get_post_meta($post->ID, $key.'_content_bottom', true );
...
if($show == 1){
	...
	if (isset($tour_content_bottom) && $tour_content_bottom > ""){
		echo '<div class="row">';
			echo '<div class="col-md-12">';
				echo themo_content($tour_content_bottom);
			echo '</div> <!-- /.class="col-md-12" -->';
		echo '</div> <!-- /.row" -->';
	}
} // end outer if / then
